      ...
      <div>
        ...
        >
          ...
          >
            ...
            <Tab eventKey="Home" title="Admin Group">
              <Carousel fade>
                <Carousel.Item>
                  <img
            ...
            <Tab eventKey="contact" title="Gym Group">
              <h3>vghtrh </h3>
            </Tab>

            <Tab eventKey="contact" title="Topper Students">
              <h3>vghtrh </h3>
            </Tab>

            <Tab eventKey="contact" title="Gym Winners">
              <h3>vghtrh </h3>
            </Tab>
